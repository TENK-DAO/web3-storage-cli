...
var fs_2 = require("ipfs-car/blockstore/fs");
var upload_1 = require("./upload");
var API_TOKEN = process.env.WEB3_STORAGE_API_TOKEN;
function makeLink(s) {
...
yargs_1.default
    ...
    .command('upload <car>', 'upload .car file to web3.storage.\nExpects env variable `WEB3_STORAGE_API_TOKEN` or --api-key', function (y) {
    y.positional('car', {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            return [2 /*return*/, (0, fs_1.packToFs)({
                    ...
                    blockstore: new fs_2.FsBlockStore()
                })];
        });
    });
}
